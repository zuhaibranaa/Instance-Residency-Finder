    ...
    <div class="add-listing-section">
        ...
        <div class="row with-forms">
            <div class="col-md-12">
                ...
                <input id="title" name="title" class="search-field" type="text" value="" required>
            </div>
        </div>
        ...
        <div class="row with-forms">
            ...
            <div class="col-md-6">
                <h5>Price </h5>
                <input id="price" name="price" class="search-field" type="text" value="" required>
            </div>
        </div>
            ...
            <div class="main-search-input">
                ...
                <div class="main-search-input-item location">
                    <div id="autocomplete-container">
                        <input name="location" id="autocomplete-input" type="text" placeholder="Location" autocomplete="off"><div id="leaflet-geocode-cont"><ul></ul></div>
